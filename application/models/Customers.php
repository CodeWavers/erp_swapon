...
class Customers extends CI_Model
{
    ...
    public function getCustomerList($postData = null)
    {
        ...
        $searchQuery = "";
        if ($searchValue != '') {
            $searchQuery = " (a.customer_name like '%" . $searchValue . "%' or a.customer_mobile like '%" . $searchValue . "%' or a.customer_email like '%" . $searchValue . "%'or a.phone like '%" . $searchValue . "%' or a.customer_address like '%" . $searchValue . "%' or a.country like '%" . $searchValue . "%' or a.state like '%" . $searchValue . "%' or a.zip like '%" . $searchValue . "%' or a.city like '%" . $searchValue . "%' or a.customer_id_two like '%" . $searchValue . "%')";
        }
        ...
        ## Fetch records
        $this->db->select("a.*,a.customer_name,a.customer_address,a.address2,a.phone,a.customer_mobile,a.customer_email,
