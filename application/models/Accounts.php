...
class Accounts extends CI_Model
{
    ...
    public function get_closing_report($per_page = null, $page = null, $outlet_id = null)
    {
    ...
    public function get_date_wise_closing_report($per_page = null, $page = null, $from_date, $to_date, $outlet_id)
    {
    ...
    public function get_data_by_headcode($coaid)
    {
        $query = $this->db->select('a.*')
            ->from('acc_coa a')
            ->where('a.HeadLevel', 3)
            ->like('a.HeadCode', $coaid, 'after')
            ->get();
