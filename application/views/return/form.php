<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <?php if ($isOutletLoggedIn) { ?>
                <div class="col-sm-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h4><?php echo "Return to Central Warehouse"; ?></h4>
                            </div>
                        </div>
                        <div class="panel-body">
                            <?php echo form_open('Cretrun_m/return_to_cw', array('class' => 'form-inline')) ?>

                            <div class="form-group">
                                <label for="to_date"><?php echo "Requisition ID" ?>:</label>
                                <input type="text" name="rqsn_id" class="form-control" id="to_date" placeholder="Requisition ID" required="required">
                            </div>
