                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6" style="margin: 0; padding: 0;">
                                <label for="pay_to" class="col-sm-4 col-form-label">Received From :</label>
                                <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <textarea name="txtRemarks" id="txtRemarks" class="form-control">Credit Voucher</textarea>
                            </div>
                        </div>
...
<script type="text/javascript">
    $(document).ready(() => {
        $("#txtRemarks").on("focus", () => {
            if ($("#txtRemarks").val() === "Credit Voucher")
                $("#txtRemarks").val('');
        });
    })
</script>