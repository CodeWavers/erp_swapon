...
<div class="row">
    <div class="col-sm-12 col-md-12">
        ...
        <?php echo display('as_on')?> Till <?php echo $dtpToDate;?></h3></td></tr>
                <tr class="table_head">
        ...
        <?php
            ...
            for($i=0;$i<count($oResultTr);$i++)
          {
            $COAID=$oResultTr[$i]['HeadCode'];
              ...
              $sql="SELECT SUM(acc_transaction.Debit) AS Debit, SUM(acc_transaction.Credit) AS Credit FROM acc_transaction WHERE acc_transaction.IsAppove =1  AND COAID LIKE '$COAID%' ";
