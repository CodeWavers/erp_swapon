...
if (isset($_POST['btnSave'])) {
    ...
    $outlet = $CI->Warehouse->outlet_or_cw_logged_in();
    ...
    $sql = $this->accounts_model->inventoryledger_firstqury($FromDate, $HeadCode, $outlet_id);
    ...
    $sql = $this->accounts_model->inventoryledger_secondqury($FromDate, $HeadCode, $ToDate, $outlet_id);
    $oResult = $oAccount->SqlQuery($sql);
                            ...
                            <div class="">
                                ...
                                <table width="100%" class="table table-stripped" cellpadding="6" cellspacing="1">
                                    <caption class="text-center">
                                        <font size="+1"> <strong><?php echo display('inventory_ledger_report') ?>(<?php echo display('from') ?> <?php echo (!empty($HeadName) ? $HeadName : '') ?> <?php echo display('on') ?> <?php echo (!empty($FromDate) ? $FromDate : ''); ?> <?php echo display('to') ?> <?php echo (!empty($ToDate) ? $ToDate : ''); ?>)</strong></font>
                                    </caption>
