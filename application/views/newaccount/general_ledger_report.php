            ...
            <div class="col-sm-12 col-md-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <div id="printArea">
                            <table class="table" width="99%" align="center" cellpadding="5" cellspacing="5" border="2" id="glReportTable">

                                <thead>
                                    <tr align="center" class="">

                                        <td colspan="10">
                                            <font size="+1"> <strong><?php echo display('general_ledger_of') . '- ' . $ledger[0]['HeadName'] . ' (' . display('on') ?> <span class="text-"><?php echo $dtpFromDate ?></span> <?php echo display('to') ?> <span class="text"> <?php echo $dtpToDate; ?></span>)</strong></font><strong></th></strong>
                                    </tr>

                                    <tr>
                                        <td height="25" align="center"><strong><?php echo display('sl'); ?></strong></td>
                                        <td align="center"><strong><?php echo "Transaction Date"; ?></strong></td>
                                        <td align="center"><strong><?php echo "Voucher No."; ?></strong></td>
                                        <td align="center"><strong><?php echo "Voucher Type"; ?></strong></td>
                                        <td align="center"><strong><?php echo !empty($Trans) ? "Transaction Date" : "Head Code"; ?></strong></td>
                                        <td align="center"><strong>Head Name</strong></td>
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td align="center"><?php echo html_escape($data->VNo); ?></td>
                                                <td align="center"><?php echo html_escape($data->Vtype); ?></td>
                                                <td align="center"><?php echo html_escape($data->COAID); ?></td>
                                                <td align="center"><?php echo html_escape($data->HeadName); ?></td>
