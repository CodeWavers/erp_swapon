                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <?php foreach ($crcc as $cracc) { ?>
                                    <?php if ($debit_info[0]['COAID'] == $cracc->HeadCode) { ?>
                                        <input type="hidden" name="cmbDebit" value="<?= $debit_info[0]['COAID'] ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="dtpDate" id="dtpDate" class="form-control datepicker" value="<?php echo $debit_info[0]['VDate']; ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="txtRemarks" class="col-sm-2 col-form-label"><?php echo display('remark') ?></label>
                            <div class="col-sm-4">
                                <textarea name="txtRemarks" id="txtRemarks" class="form-control" readonly><?php echo $debit_info[0]['Narration']; ?></textarea>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            <td class="" width="300px">
                                                <?php foreach ($acc as $acc1) { ?>
                                                    <?php if ($upcrvoucher->COAID == $acc1->HeadCode) { ?>
                                                        <input class="form-control" type="text" name="" value="<?php echo $acc1->HeadName; ?>" readonly>
                                                <?php }
                                                } ?>

                                            </td>
                                            <td><input type="text" name="txtCode[]" value="<?php echo $upcrvoucher->COAID ?>" class="form-control " id="txtCode_<?php echo $sl; ?>" readonly></td>
