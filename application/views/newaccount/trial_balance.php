                ...
                <div class="row" id="">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input  autocomplete="off" type="text" name="dtpFromDate" value="" placeholder="<?php echo display('from_date') ?>" class="datepicker form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input autocomplete="off" type="text"  name="dtpToDate" value="" placeholder="<?php echo display('to_date') ?>" class="datepicker form-control">
                            </div>
                        </div>
                        <div class="form-group row">
