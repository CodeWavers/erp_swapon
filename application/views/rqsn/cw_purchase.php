...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Central Warehouse Requisition </h1>
            <small>Requisition Form</small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#">Central Warehouse Requisition </a></li>
            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="rqsn_panel">
                        <?php echo form_open_multipart('Crqsn/insert_rqsn_cw', array('class' => 'form-vertical', 'id' => 'insert_rqsn')) ?>
                        <div class="row">
