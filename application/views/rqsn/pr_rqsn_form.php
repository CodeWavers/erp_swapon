...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Production Requisition</h1>
            <small>Production Requisition Form</small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#">Production Requisition</a></li>
                <li class="active">Production Requisition Form</li>
            </ol>
        </div>
    </section>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4>Production Requisition Form</h4>
                    ...
                    <div class="rqsn_panel" >
                        <?php echo form_open_multipart('Crqsn/insert_rqsn_pr',array('class' => 'form-vertical', 'id' => 'insert_rqsn'))?>
                        <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="to_id" class="form-control" required=""  tabindex="3">
                                            ...
                                            <?php foreach($role_list as $role){?>
                                                <option value="<?php echo html_escape($role['id'])?>"><?php echo html_escape($role['type']) ;?></option>
                                            <?php }?>
