            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                            ...
                            <div class="col-sm-6">
                                <select name="customer_id" class="form-control" required="">
                                    ...
                                    <?php foreach ($customer_list as $customers) { ?>
                                        <option value="<?php echo html_escape($customers['customer_id']) ?>"><?php echo html_escape($customers['customer_name']  . ' (' . $customers['customer_mobile'] . ')') ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="" id="bank_div_1" style="display:none;">
                            <div class="form-group row">
                        ...
                        <div class="" style="display: none" id="bkash_div_1">
                            ...
                            <div class="form-group row">
                                <label for="bkash" class="col-sm-3 col-form-label">Bkash Number <i class="text-danger">*</i></label>
                                <div class="col-sm-6">
                        ...
                        <div class="" style="display: none" id="nagad_div_1">
                            <div class="form-group row">
                                <label for="nagad" class="col-sm-3 col-form-label">Nagad Number <i class="text-danger">*</i></label>
                                <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <textarea name="Purpose" id="Purpose" class="form-control" rows="5" placeholder="Reason for advance"></textarea>
                            </div>
                        </div>
