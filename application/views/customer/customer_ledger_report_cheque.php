...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Paid Cheque </h1>
            <small>Manage Paid Cheque </small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('customer') ?></a></li>
                <li class="active">Paid Cheque</li>
            </ol>
        </div>
    </section>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        <?php echo form_open('Ccustomer/customer_ledgerData_cheque', array('class' => '', 'id' => 'validate')) ?>
                                        ...
                                        if ($ledgers) {
                                            ...
                                            foreach ($ledgers as $ledger) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="200" ><?php echo html_escape($ledger['Narration']); ?></td>
                                                    <td class="text-center"><?php echo html_escape($ledger['cheque_no']); ?></td>
                                                    <td class="text-center"><?php echo html_escape($ledger['cheque_date']); ?></td>
                                                    <td class="text-center"><?php echo html_escape($ledger['payment_date']); ?></td>
