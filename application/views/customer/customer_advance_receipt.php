                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <table border="0" width="100%">
                                                ...
                                                <tr>
                                                    <td align="center" style="padding-top: 20px;"><b>{customer_name}</b><br>
                                                        <?php if ($address) { ?>
                                                            {address}<br>
                                                        <?php } ?>
                                                        <?php if ($mobile) { ?>
                                                ...
                                                <tr>
                                                    <td class="text-center" style="padding-bottom: 10px;"><strong><?php echo display('receipt_no'); ?> : {receipt_no}</strong></td>
                                                </tr>
                                            ...
                                            <table border="1" width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <nobr><?php echo ($status == 'Payment') ? html_escape($details[0]['Debit']) : html_escape($details[0]['Credit']); ?></nobr>
                                                    </td>
