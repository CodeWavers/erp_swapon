                  ...
                  <?php echo form_open_multipart('Ccustomer/customer_update',array('class' => 'form-vertical', 'id' => 'customer_update'))?>
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" name="contact" id="contact" type="text" value="{contact_person}" placeholder="Contact Person"  >
                            </div>
                        </div>
                          <div class="form-group row">
                            <label for="contact" class="col-sm-4 col-form-label">Contact Mobile <i class="text-danger"></i></label>
                            <div class="col-sm-8">
                                <input class="form-control" name="contact" id="contact" type="text" value="{contact}" placeholder="Contact Mobile"  >
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" name="state" id="state" type="text" value="{state}" placeholder="Police Station"  >
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="address " class="col-sm-4 col-form-label">Organization Address</label>
                            <div class="col-sm-8">
                                <textarea class="form-control" name="address" id="address " rows="3" placeholder="Customer Address" tabindex="4">{customer_address} </textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="address2 " class="col-sm-4 col-form-label">District</label>
                            <div class="col-sm-8">
                                <textarea class="form-control" name="address2" id="address2" rows="2" placeholder="District" >{address2}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="website " class="col-sm-4 col-form-label">Website</label>
                            <div class="col-sm-8">
                                <textarea class="form-control" name="website" id="website" rows="2" placeholder="Website" >{website}</textarea>
                            </div>
                        </div>
