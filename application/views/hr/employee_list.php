<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <?php if($this->permission1->method('manage_employee','update')->access()){ ?>                          
                                        <a href="<?php echo base_url() . 'Chrm/employee_update_form/'.$employees['employee_id']; ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                    <?php }?>
    <?php if($this->permission1->method('manage_employee','delete')->access()){ ?>                                
                                        <a href="<?php echo base_url('Chrm/employee_delete/'.$employees['employee_id']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('<?php echo display('are_you_sure') ?>')" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                         <?php }?>
                                   <a href="<?php echo base_url('Chrm/employee_details/'.$employees['employee_id']);?>" class="btn btn-default"><i class="fa fa-user"></i></a>
                                            <?php echo form_close() ?>
                                    </center>
                                    </td>
                                    </tr>
