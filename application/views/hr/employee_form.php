            ...
            <div class="col-sm-12">
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <h4><u><strong>Employee Information:</strong></u></h4>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input name="employee_id" class="form-control" type="text" placeholder="Employee ID" required id="employee_id">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input name="father_name" class="form-control" type="text" placeholder="Father Name"  id="father_name">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input name="mother_name" class="form-control" type="text" placeholder="Mother Name" id="mtoher_name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input name="department" class="form-control" type="text" placeholder="Department" id="department">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input name="age" class="form-control" type="number" placeholder="Age" id="age">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input name="dob" class="form-control datepicker" type="text" placeholder="Date of birth" id="dob" required>
                            ...
                            <div class="col-sm-4">
                                ...
                                <input name="training" class="form-control" type="text" placeholder="Training" id="training">
                        ...
                        <div class="form-group row" id="tr_info">
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td> <input size="40" name="tr_centre[]" class="form-control" type="text" placeholder="Training Centre" id="company"></td>
                                    <td> <input size="40" name="tr_name[]" class="form-control" type="text" placeholder="Training Name" id="designation"></td>
                                    <td> <input size="40" name="tr_duration[]" class="form-control" type="text" placeholder="Duration" id="duration"></td>
                                    <td><button   class='btn btn-primary text-right add_tr' type='button'><i class='fa fa-plus-circle'></i></button></td>
                        ...
                        <div class="form-group row" id="ac_info">
                            <table class="table table-striped">
                                ...
                                <tr>
                                   ...
                                   <td><button   class='btn btn-primary text-right add_cheque' type='button'><i class='fa fa-plus-circle'></i></button></td>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <textarea name="address_line_1" class="form-control" placeholder="Present Address" id="address_line_1"></textarea>
                            ...
                            <div class="col-sm-4">
                                ...
                                <textarea name="address_line_2" class="form-control" placeholder="Permanent Address" id="address_line_2"></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input name="nid_number" class="form-control" type="text" placeholder="NID/Passport" id="nidNumber">
                        ...
                        <div class="form-group row" id="ex_info">
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td> <input size="40" name="company[]" class="form-control" type="text" placeholder="Company Name" id="company"></td>
                                    <td> <input size="40"  name="des[]" class="form-control" type="text" placeholder="Designation" id="designation"></td>
                                    <td> <input size="40" name="duration[]" class="form-control" type="text" placeholder="Duration" id="duration"></td>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input name="nominee_name" class="form-control" type="text" placeholder="<?php echo display('name') ?>"  id="name">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input name="nominee_nid" class="form-control" type="text" placeholder="NID" id="nidNumber">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input name="nominee_phone" class="form-control" type="number" placeholder="<?php echo display('phone') ?>" id="phone" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input name="gua_name" class="form-control" type="text" placeholder="<?php echo display('name') ?>"  id="name">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input name="gua_profession" class="form-control" type="text" placeholder="Profession" id="profession">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input name="gua_nid" class="form-control" type="text" placeholder="NID" id="nidNumber">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input name="gua_phone" class="form-control" type="number" placeholder="<?php echo display('phone') ?>" id="phone" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input name="fam_name" class="form-control" type="text" placeholder="<?php echo display('name') ?>"  id="name">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input name="fam_profession" class="form-control" type="text" placeholder="Profession" id="profession">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input name="fam_nid" class="form-control" type="text" placeholder="NID" id="nidNumber">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input name="fam_phone" class="form-control" type="number" placeholder="<?php echo display('phone') ?>" id="phone" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input name="fam_relation" class="form-control" type="text" placeholder="Relation" id="nidNumber">
