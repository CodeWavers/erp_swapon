...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Nagad Transaction</h1>
            <small>Nagad Transaction</small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#">Nagad</a></li>
                <li class="active">Nagad Transaction</li>
            </ol>
        </div>
    </section>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <?php if($this->permission1->method('add_bank','create')->access()){ ?>
                  <a href="<?php echo base_url('Csettings/nagad')?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-align-justify"> </i> <?php echo display('add_new_bank')?> </a>
              <?php }?>
             <?php if($this->permission1->method('bank_list','read')->access()){ ?>
                  <a href="<?php echo base_url('Csettings/nagad_list')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-align-justify"> </i>  <?php echo display('manage_bank')?> </a>
                   <?php }?>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4>Nagad Transaction </h4>
                        </div>
                    </div>
                   <?php echo form_open_multipart('Csettings/nagad_debit_credit_manage_add',array('class' => 'form-vertical','id' => 'validate' ))?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <label for="bank_name" class="col-sm-3 col-form-label">Nagad Number <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <select class="form-control" name="nagad_id" tabindex="3">
                                    {nagad_list}
                                    <option value="{nagad_id}">{nagad_no}({ac_name})</option>
                                    {/nagad_list}
                                </select>
                            </div>
                        </div>
