...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Add Rocket Number</h1>
            <small>Add Rocket Number</small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#">Rocket</a></li>
                <li class="active">Add Rocket Number</li>
            </ol>
        </div>
    </section>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <?php if ($this->permission1->method('bank_transaction', 'create')->access()) { ?>
                    <a href="<?php echo base_url('Csettings/rocket_transaction') ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-align-justify"> </i> rocket Transaction </a>
                <?php } ?>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4>Add Rocket Number </h4>
                        </div>
                    </div>
                    <?php echo form_open_multipart('Csettings/add_new_rocket', array('class' => 'form-vertical', 'id' => 'validate')) ?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="rocket_no" id="rocket_no" required="" placeholder="Rocket Number" tabindex="3" />
                            </div>
                        </div>
