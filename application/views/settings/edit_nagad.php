...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Nagad Edit</h1>
            <small>Nagad Edit</small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#">Nagad</a></li>
                <li class="active">Nagad Edit></li>
            </ol>
        </div>
    </section>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Csettings/update_nagad/' . $nagad_list[0]['nagad_id'], array('class' => 'form-vertical', 'id' => 'validate')) ?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="nagad_no" id="nagad_no" required="" placeholder="Nagad Number" value="<?php echo $nagad_list[0]['nagad_no'] ?>" tabindex="3" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select name="nagad_type" class="form-control bankpayment" id="bank_id">
                                    ...
                                    <option value="<?php echo $nagad_list[0]['nagad_type'] ?>" selected><?php echo $nagad_list[0]['nagad_type'] ?></option>
