...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Add Bkash Number</h1>
            <small>Add Bkash Number</small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#">Bkash</a></li>
                <li class="active">Add Bkash Number</li>
            </ol>
        </div>
    </section>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4>Add Bkash Number </h4>
                        </div>
                    </div>
                    <?php echo form_open_multipart('Csettings/add_new_bkash', array('class' => 'form-vertical', 'id' => 'validate')) ?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" name="bkash_no" id="bkash_no" required="" placeholder="Bkash Number" tabindex="3" />
                            </div>
                        </div>
