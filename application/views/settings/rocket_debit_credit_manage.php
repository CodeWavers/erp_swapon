...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Rocket Transaction</h1>
            <small>Rocket Transaction</small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#">Rocket</a></li>
                <li class="active">Rocket Transaction</li>
            </ol>
        </div>
    </section>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <?php if($this->permission1->method('add_bank','create')->access()){ ?>
                  <a href="<?php echo base_url('Csettings/rocket')?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-align-justify"> </i> Add New Rocket </a>
              <?php }?>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4>Rocket Transaction </h4>
                        </div>
                    </div>
                   <?php echo form_open_multipart('Csettings/rocket_debit_credit_manage_add',array('class' => 'form-vertical','id' => 'validate' ))?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <label for="bank_name" class="col-sm-3 col-form-label">Rocket Number <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <select class="form-control" name="rocket_id" tabindex="3">
                                    {rocket_list}
                                    <option value="{rocket_id}">{rocket_no}({ac_name})</option>
                                    {/rocket_list}
                                </select>
                            </div>
                        </div>
