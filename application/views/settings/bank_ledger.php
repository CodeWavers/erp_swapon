			...
			<div class="col-sm-12">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-sm-6">
								<label class="col-form-label col-sm-4"><?php echo display('bank') ?> : </label>
								<div class="col-sm-8">
									<select name="bank_id" class="form-control">
										<option value="">Select Bank</option>
										<?php foreach ($bank_list as $banks) { ?>
											<option value="<?php echo $banks['bank_id'] ?>"><?php echo $banks['bank_name'] ?>(<?php echo $banks['ac_number'] ?>)</option>
										<?php } ?>
									</select>
								</div>
							</div>
						...
						<div class="row" style="margin-top: 10px;">
							<div class="col-sm-4">
								...
								<input type="text" name="from_date" value="<?php echo $today; ?>" class="datepicker form-control" autocomplete="off" />
							</div>
							<div class="col-sm-4">
								<label class="select"><?php echo display('to') ?></label>
								<input type="text" name="to_date" class="datepicker form-control" value="<?php echo $today; ?>" autocomplete="off" />
							</div>
							<div class="col-sm-4">
