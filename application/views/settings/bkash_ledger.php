...
<div class="content-wrapper">
	<section class="content-header">
		...
		<div class="header-title">
			<h1>Bkash Ledger</h1>
			<small>Bkash Ledger</small>
			<ol class="breadcrumb">
				<li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
				<li><a href="#"><?php echo display('bank') ?></a></li>
				<li class="active">Bkash Ledger</li>
			</ol>
		</div>
	</section>
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<?php if ($this->permission1->method('bank_transaction', 'create')->access()) { ?>
					<a href="<?php echo base_url('Csettings/bkash_transaction') ?>" class="btn btn-primary m-b-5 m-r-2"><i class="ti-align-justify"> </i> Bkash Transaction </a>
				<?php } ?>
			...
			<div class="col-sm-12">
				<div class="panel panel-default">
					<div class="panel-body">
						<?php echo form_open('Csettings/bkash_ledger/', array('class' => 'form-inline', 'method' => 'post')) ?>
						<?php $today = date('Y-m-d'); ?>
						<label class="select">Bkash: </label>
						<select name="bkash_id" class="form-control">
