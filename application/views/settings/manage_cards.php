	...
	<section class="content-header">
		...
		<div class="header-title">
			...
			<ol class="breadcrumb">
				...
				<li class="active">Manage Card Types</li>
			</ol>
		</div>
	</section>
									...
									<?php if ($card_list) { ?>
										...
										<tr>
											...
											<td>
												...
												<?php if (true) { ?>
													<a href="<?php echo base_url() .
																	'Csettings/edit_card/{card_id}'; ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?php echo display(
																																																					'update'
																																																				); ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
													<a href="<?php echo base_url() .
																	'Csettings/delete_card/{card_id}'; ?>" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="left" title="" data-original-title="<?php echo display(
																																																						'update'
