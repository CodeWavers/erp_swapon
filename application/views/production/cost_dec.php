<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Production </h1>
            <small>Production Cost Declare</small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#">Production</a></li>
                <li class="active">Production Cost Declare</li>
            </ol>
        </div>
    </section>
    ...
    <section class="content">
        ...
        ?>
        <?php echo form_open('Cproduction/save_production_cost', array('class' => 'form-vertical', 'id' => 'submit_form', 'name' => '')) ?>
            ...
            <div class="col-sm-12 col-md-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body ">
                        ...
                        <div class="margin-top10 rqsn_panel">
            ...
            if (e.keyCode == 13) {
                ...
                if (product_id == exist) {
                    ...
                    $.ajax({
                        type: "post",
                        async: false,
                        url: base_url + 'Cproduction/append_product',
                        data: {
