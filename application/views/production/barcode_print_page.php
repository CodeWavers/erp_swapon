        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Cproduction/insert_production') ?>
                    <div class="panel-body">

                        <?php
                        if (!empty($production_id) || !empty($qr_image)) {
                            ?>
                            <div class="text-center">
                                <a  class="btn btn-info" href="#" onclick="printDiv('printableArea')"><?php echo display('print') ?></a>
                                <a  class="btn btn-danger" href="<?php echo base_url('Cproduction'); ?>"><?php echo display('cancel') ?></a>
                            </div>
                            <?php
                        }
                        ?>
                                            ...
                                            <?php if ($counter == $cqty) { ?>
                                                ...
                                                <td class="barcode-toptd">      
                                                    ...
                                                    <div class="barcode-inner barcode-innerdiv">
                                                        ...
                                                        <img src="<?php echo base_url('Cbarcode/barcode_generator_production/{production_id}') ?>" class="img-responsive center-block barcode-image" alt="" >
