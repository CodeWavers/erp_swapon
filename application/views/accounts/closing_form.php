            ...
            <div class="col-sm-6">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <?php echo form_open_multipart('Accounts/add_daily_closing', array('class' => 'form-vertical', 'id' => 'daily_closing')) ?>
                        <!--                        <form action="--><?php //echo base_url()
                                                                        ?>
                        <!--Caccounts/add_daily_closing" method="post">-->
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="200"><?php echo '200'; ?></td>
                                    <td><input type="number" class="form-control text_0" name="twohund" onkeyup="cashCalculator()" onchange="cashCalculator()"></td>
                                    <td><input type="text" class="form-control text_0_bal" readonly=""></td>
                                </tr>
                                <tr>
