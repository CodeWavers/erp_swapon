                    ...
                    <div class="panel-body category">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="add_category" class="tab-pane fade">
                                <div class="row cat-tabcontent">
                                    <?php echo form_open('Ccwarehouse/insert_branch', array('class' => 'form-vertical', 'id' => 'insert_category')) ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="customer_id" tabindex="3">
