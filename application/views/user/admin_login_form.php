    ...
    <div class="panel panel-bd ">
        ...
        <div class="panel-body ">
            ...
            <div class="form-group">
                ...
                <span><?php echo display('your_strong_password') ?> <a href="#"  data-toggle="modal" data-target="#passwordrecoverymodal"><b class="text-right" style="color: #0d71bb"><?php echo display('forgot_password')?></b></a></span>
            </div>
