	                    ...
	                    <div class="panel-body">
	                        <div class="row">
	                            ...
	                            <div class="col-sm-4 text-left invoice-details-billing">
	                                <h2 class="m-t-0">Warrenty Return</h2>
	                                <div>Warrenty ID: {invoice_no}</div>
...
<!--	                                        <th class="text-center">--><?php //echo display('ammount') ?><!--</th>-->
	                                ...
	                                <tbody>
										...
										<tr>
                                            ...
                                            <td align="center"><?php echo (($position==0)?"$currency {service_charge}":"{service_charge} $currency") ?></td>
...
<!--	                                        <td align="center">--><?php //echo (($position==0)?"$currency {total_ret_amount}":"{total_ret_amount} $currency") ?><!--</td>-->
                     ...
                     <div class="panel-footer text-left">
                     	<a  class="btn btn-danger" href="<?php echo base_url('Cwarrenty');?>"><?php echo display('cancel') ?></a>
