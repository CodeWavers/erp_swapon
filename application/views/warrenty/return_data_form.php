...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <small>Warrenty Return</small>
             <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#">Warrenty Return</a></li>
                <li class="active">Warrenty Return</li>
            </ol>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4>Sale warrenty return</h4>
                        </div>
                    </div>
                    <?php echo form_open('Cwarrenty/return_invoice', array('class' => 'form-vertical', 'id' => 'invoice_update')) ?>
                    <div class="panel-body">
                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tbody id="addinvoiceItem">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text"  name="ret_qty[]"  onkeyup="quantity_calculate({sl});" onchange="quantity_calculate({sl});"  class="total_qntt_{sl} form-control text-right" id="total_qntt_{sl}" min="0" placeholder="0.00" tabindex="4" />
                                        </td>

                                        <td>
                                            <input type="text" name="warrenty_date[]" id="" class="form-control text-right" value="{warrenty_date}" readonly="" />
                                        </td>
                                        ...
                                        <td>
                                            <input class="total_price form-control text-right" type="text"  id="total_price_{sl}" value=""  />
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <input id="total_tax_ammount" tabindex="-1" class="form-control text-right valid" name="total_tax" value="{total_tax}"  aria-invalid="false" type="text" readonly="readonly">
                                    </td>
                                </tr>

                                    <tr>
                                        <td class="text-right" colspan="1" ><b>Additional Charge:</b></td>
                                        <td class="text-right">
                                            <input id="" tabindex="-1" class="form-control text-right valid" name="service_charge" value=""  aria-invalid="false" type="text">
                                        </td>
                                    </tr>
                                <tr>
                                    <td colspan="6"  class="text-right"><b><?php echo display('nt_return') ?>:</b></td>
                                    <td class="text-right">
                                        <input type="text" id="grandTotal" class="form-control text-right" name="grand_total_price" value=""  />
                                    </td>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 text-right">
                                ...
                                <input type="submit" id="add_invoice" class="btn btn-success btn-large" name="add-invoice" value="Apply" tabindex="9"/>
