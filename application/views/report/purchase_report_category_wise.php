                    ...
                    <div class="panel-body">
                        <div id="purchase_div" class="table-responsive">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover" id="catWisePurTable">
                                    <thead>
                                        <tr>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="5" class="text-right"><b><?php echo "Total Purchase" ?></b></td>
