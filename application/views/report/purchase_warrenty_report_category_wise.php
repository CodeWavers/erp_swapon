...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo 'Category Wise Warrenty Report'?></h1>
            <small><?php echo 'Category Wise Warrenty Report' ?></small>
            <ol class="breadcrumb">
            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        <?php echo form_open('Admin_dashboard/filter_purchase_warrenty_report_category_wise', array('class' => 'form-inline', 'method' => 'post')) ?>
                        <?php
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo 'Category Wise Warrenty Report' ?> </h4>
                        </div>
                    </div>
                    <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                        $total = 0 ;
                                        if ($purchase_warrenty_report_category_wise) {
                                            foreach ($purchase_warrenty_report_category_wise as $single) {
                                                ?>
                                                <tr>
                                        ...
                                        <td><?php echo html_escape($single->warrenty_date); ?></td>
