                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="number" tabindex="3" class="form-control" name="mobile" value="{mobile}"  placeholder="<?php echo display('mobile') ?>" required tabindex="2"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="bank_name" class="col-sm-3 col-form-label">Phone <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input type="number" tabindex="3" class="form-control"  name="phone" value="{phone}"  placeholder="Phone" required tabindex="2"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="bank_name" class="col-sm-3 col-form-label">Email2 <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <input type="email" tabindex="3" class="form-control" value="{email2}" name="email2" placeholder="<?php echo display('email') ?>" required tabindex="4"/>
                            </div>
                        </div>
