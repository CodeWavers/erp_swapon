                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="text" size="100" name="customer_name" class=" form-control" placeholder='Customer Name' id="customer_name" tabindex="1" onkeyup="customer_autocomplete()" value="{customer_name}" autocomplete="off" />
                            ...
                            <?php } ?>
                            <input type="hidden" name="isAdd" id="outlet_id" value=<?= $outlet_id ?>>
                            <div class="col-sm-6">
                                    ...
                                    <table class="table table-bordered table-hover" id="normalinvoice">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                ...
                                                <input type="text" id="paidAmount" class="form-control text-right" name="paid_amount" placeholder="0.00" tabindex="15" value="" readonly />
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <input type="text" id="due_amount" class="form-control text-right" name="due_amount" placeholder="0.00" tabindex="15" value="" readonly />
                                            </td>
                                        </tr>
