                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo 'Pre Order';
                                $_SESSION['redirect_uri'] = 'Cquotation';
                                ?></h4>
                    ...
                    <div class="panel-body">
                        <?php echo form_open_multipart('Cquotation/pre_order', array('class' => 'form-vertical', 'id' => '', 'name' => '')) ?>
                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tr>
                                    ...
                                    <td  width="200" class="text-center">
                                        ...
                                        <input class="comm_th form-control text-right d-none p-5" style="width: 120px ;" type="text" name="comm[]" id="comm_1" value="0" onkeyup="quantity_calculate_pre(1);" onchange="quantity_calculate_pre(1);"  />
