    ...
    <div class="firts_section" style="">
        <div class="first_section_left"  style="width: 38%; display: inline-block;">
            ...
            if (isset($currency_details[0]['invoice_logo'])) {
                echo $currency_details[0]['invoice_logo'];
            }
    ...
    <div class="">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;padding: 5px;"><b>
                                ...
                                echo (($position == 0) ? " $ttldiscountamount" : "$ttldiscountamount ");
                                ?>
                            </b></td>
                    </tr>
                    <tr>
                        <td colspan="5" style="text-align: right;  padding: 5px;"><b><?php echo display('total_tax') ?></b></td>
                        <td style="text-align:right;padding: 5px;"><b>
                                <?php
                                $itemtotaltax = $quot_main[0]['item_total_tax'];
                                echo (($position == 0) ? " $itemtotaltax" : "$itemtotaltax ");
                                ?>
                            </b></td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align:right;padding: 5px;"><b>
                                ...
                                echo (($position == 0) ? " $ttlamount" : "$ttlamount ");
                                ?>
                            </b>
        ...
        if (!empty($quot_service[0]['service_name'])) {
            ...
            <div class="table-responsive m-b-20">
                <table class="table table-striped">
                    <caption align="center"> <h2 style="border:1px;background-color: #DDE4EB;color:#000"><?php echo display('service').' '.display('quotation')?> </h2></caption>
                    <thead>
                    <tr>
                        <th><?php echo display('sl') ?></th>
                        <th align="left"><?php echo display('service_name') ?></th>
                        <th align="center"><?php echo display('qty') ?></th>
                        <th align="right"><?php echo display('charge') ?></th>
                        <?php if ($discount_type == 1) { ?>
                            <th align="right"><?php echo display('discount_percentage') ?> %</th>
                        <?php } elseif ($discount_type == 2) { ?>
                            <th align="right"><?php echo display('discount') ?> </th>
                        <?php } elseif ($discount_type == 3) { ?>
                            <th align="right"><?php echo display('fixed_dis') ?> </th>
                        <?php } ?>
                        <th align="right"><?php echo display('total') ?></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    foreach ($quot_service as $service) {
                        ...
                        <tr>
                            ...
                            <td align="right">
                                ...
                                echo (($position == 0) ? " $totalcharge" : "$totalcharge ");
                                ?>
                            </td>
                        </tr>
                        <?php
                    ...
                    <tr>
                        ...
                        <td style="text-align: right;  padding: 5px;"><b>
                                ...
                                echo (($position == 0) ? " $subtotalservice" : "$subtotalservice ");
                                ?>
                            </b></td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align: right;  padding: 5px;"><b>
                                ...
                                echo (($position == 0) ? " $servicediscount" : "$servicediscount ");
                                ?>
                            </b></td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align: right;  padding: 5px;"><b>
                                ...
                                echo (($position == 0) ? " $servicetotaltax" : "$servicetotaltax ");
                                ?>
                            </b></td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align: right;  padding: 5px;"><b>
                                ...
                                echo (($position == 0) ? " $servicetotalamount" : "$servicetotalamount ");
                                ?>
                            </b>
