                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <div class="form-group row">
                            <input type="hidden" name="outlet_id" id="outlet_id" value="<?php echo $quot_main[0]['outlet_id']; ?>">
                            <div class="col-sm-6">
                                    ...
                                    <div class="table-responsive margin-top10">
                                        <table class="table table-bordered table-hover" id="normalinvoice">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right" colspan="6"><b>Advance Paid:</b></td>
                                                <td class="text-right">
                                                    <input type="hidden" name="baseUrl" class="baseUrl" value="<?php echo base_url(); ?>" />
                                                    <input type="text" id="paidAmount" class="form-control text-right" name="paid_amount" placeholder="0.00" tabindex="15" value="<?php echo $quot_main[0]['advance_paid']; ?>" readonly />
                                                </td>
                                            </tr>

                                            <tr>

                                                <td class="text-right" colspan="6"><b>Due:</b></td>
                                                <td class="text-right">
                                                    <input type="text" id="due_amount" class="form-control text-right" name="due_amount" placeholder="0.00" tabindex="15" value="<?php echo $quot_main[0]['due_amount']; ?>" readonly />
                                                </td>
                                            </tr>
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="alert alert-warning" style="background-color: #ffc75120; border-color:#ffc75120; color:black">
                                            <span>
                                                <strong>Note:</strong>
                                                You have to add all the payments (new + saved) every time if you want to update the payment.
                                            </span>
                                        </div>
