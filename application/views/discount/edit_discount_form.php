            ...
            <div class="col-sm-12">
                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="rqsn_panel" >
                        ...
                        <?php echo form_open_multipart('Cdiscount/update_discount','id="myform"') ?>
...
<!--                                    <th class="text-center">--><?php //echo display('action') ?><!--</th>-->
                                ...
                                <tr>
                                    <td class="product_field">
                                        <input autocomplete="off" type="text" required name="customer_name" onkeypress="invoice_customerList(1)" id="customer_name_1" class="form-control productSelection" placeholder="Customer Name"  value="<?php echo $customer_name?>" tabindex="5" >

                                        <input autocomplete="off" type="hidden" class="autocomplete_hidden_value customer_id_1" name="customer_id" value="<?php echo $customer_id?>" id="SchoolHiddenId"/>
                                        <input autocomplete="off" type="hidden" class="" name="discount_id" value="<?php echo $discount_id?>" id=""/>
                                    ...
                                    <td>
                                        <input autocomplete="off" type="text" required name="product_name" onkeypress="invoice_categoryList(1)" id="category_name_1" class="form-control productSelection" placeholder="Category Name"   value="<?php echo $category_name?>" tabindex="5">

                                        <input autocomplete="off" type="hidden" class="autocomplete_hidden_category_value category_id_1"  value="<?php echo $category_id?>"  name="category_id" id="SchoolHiddenId"/>
                                    </td>
                                    <td>
                                        <input type="text" name="discount" required=""  class="total_qntt_1 form-control text-right" id="total_qntt_1" placeholder="0.00" min="0" tabindex="8"  value="<?php echo $discount?>" />
                                    </td>
