  ...
  <div id="csvupload" class="tab-pane fade">
     ...
     <div class="panel">
                    ...
                    <div class="panel-body">
                         <div><a href="<?php echo base_url('assets/data/csv/size_csv_sample.csv') ?>" class="btn btn-primary pull-right"><i class="fa fa-download"></i><?php echo display('download_sample_file')?> </a> </div>

                      <?php echo form_open_multipart('Cproduct/uploadCsv_size',array('class' => 'form-vertical', 'id' => 'validate','name' => 'insert_category'))?>
                            <div class="col-sm-12">
                                <div class="form-group row">
