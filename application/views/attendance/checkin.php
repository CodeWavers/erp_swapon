                       ...
                       <?php  if($this->session->userdata('isAdmin')==1){?> 
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-9 picker-container">                          
                                 ...
                                 <input type="text" id="date" value="<?php echo  date('Y-m-d');?>" name="date" class="form-control" readonly>
                            </div>
                        </div>
                              <div class="form-group row ">
                            ...
                            <div class="col-sm-9 picker-container">
                                 ...
                                 <input type="text" id="timepicker-12-hr" value="<?php date_default_timezone_set("Asia/Dhaka"); echo  date("h:ia");?>" name="intime" class="form-control" readonly>
                            </div>
                        </div>
