                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-sm-8" id="bank_div_m"  style="display: none">
                            ...
                            <div class="col-sm-8" style="display: none" id="bkash_div">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="bkash_id" class="form-control bankpayment"  id="bkash_id">
                                            <option value="<?php echo $bkash_id?>"><?php echo $bkash_no.'('.$ac_name.')'?></option>
