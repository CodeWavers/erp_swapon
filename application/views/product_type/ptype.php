...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <small>Manage Your Product Type</small>
            <ol class="breadcrumb">
 ...
 <?php if($this->permission1->method('create_category','create')->access()){ ?>
                    <a href="<?php echo base_url('Cptype') ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('add_category') ?> </a>
<?php }?>
<?php if($this->permission1->method('create_category','create')->access()){ ?>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                           <a href="<?php echo base_url('Cptype/category_downloadpdf')?>" class="btn btn-warning">Pdf</a>
                        </div>
                    </div>
