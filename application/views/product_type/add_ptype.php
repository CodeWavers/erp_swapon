                 ...
                 <div class="panel panel-bd lobidrag">
                     ...
                     <div class="panel-body category">
                         <ul class="nav nav-tabs">
                             <li class="active"><a data-toggle="tab" href="#categoryList"><i class="ti-align-justify"> </i> Manage Product Type</a></li>
                             <li><a data-toggle="tab" href="#add_category"><i class="fa fa-plus"> </i> Add Product Type</a></li>
                             <li><a data-toggle="tab" href="#csvupload"><i class="fa fa-file"> </i> Product Type CSV Upload</a></li>
                         </ul>
                         ...
                         <div class="tab-content">
                                                         ...
                                                         <td>
                                                             <center>
                                                                 ...
                                                                 <?php if ($this->permission1->method('manage_category', 'update')->access()) { ?>
                                                                     <a href="<?php echo base_url() . 'Cptype/category_update_form/{ptype_id}'; ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                                                 <?php } ?>
                                                                 <?php if ($this->permission1->method('manage_category', 'delete')->access()) { ?>
                                                                     <a href="<?php echo base_url() . 'Cptype/category_delete/{ptype_id}'; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are You Sure To Want To Delete ?')" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                                                 <?php } ?>
                                                                 <?php echo form_close() ?>
                                                             </center>
                                                         </td>
                             ...
                             <div id="add_category" class="tab-pane fade">
                                 <div class="row cat-tabcontent">
                                     <?php echo form_open('Cptype/insert_category', array('class' => 'form-vertical', 'id' => 'insert_category')) ?>

                                     <div class="form-group row">
                                         <label for="category_name" class="col-sm-3 col-form-label">Product Type <i class="text-danger">*</i></label>
                                         <div class="col-sm-6">
                                             <input class="form-control" name="ptype_name" id="category_name" type="text" placeholder="Product Type Name" required="">
                                         </div>
                                 ...
                                 <div class="row cat-tabcontent">
                                     <div class="panel">
                                         ...
                                         <div class="panel-body">
                                             ...
                                             <?php echo form_open_multipart('Cptype/uploadCsv_category', array('class' => 'form-vertical', 'id' => 'validate', 'name' => 'insert_category')) ?>
                                             <div class="col-sm-12">
                                                 <div class="form-group row">
