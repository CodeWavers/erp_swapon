...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Wastage</h1>
            <small>Wastage Declaration</small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#">Stock</a></li>
                <li class="active">Wastage Declaration</li>
            </ol>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <input type="hidden" class="outlet_id" value="{outlet_id}" />
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4>Wastage Declaration</h4>

                        </div>
                    </div>

                    <div class="rqsn_panel" >
                        <?php echo form_open_multipart('Creport/wastage_entry',array('class' => 'form-vertical', 'id' => 'insert_rqsn'))?>
    ...
    function addInputField(t) {
        ...
        if (count == limits)
            ...
            e.innerHTML = "<td><input type='text' name='product_name' onkeypress='invoice_productList(" + count + ");' class='form-control productSelection common_product' placeholder='Product Name' id='" + a + "' required tabindex='" + tab1 + "'><input type='hidden' class='common_product autocomplete_hidden_value  product_id_" + count + "' name='product_id[]' id='SchoolHiddenId'/></td>" +
                "<td><input class='form-control text-right common_name sku_" + count + " valid' name='sku[]' value='None' readonly='' aria-invalid='false' type='text'></td> " +
                "<td><input class='form-control text-right common_name available_quantity_" + count + " valid' name='available_quantity_[]' value='None' readonly='' aria-invalid='false' type='text'></td>" +
                "<td><input class='form-control text-right common_name unit_" + count + " valid' name='unit[]' value='None' readonly='' aria-invalid='false' type='text'></td>" +
                "<td> <input type='text' name='product_quantity[]' value='1' required='required'  onchange='quantity_calculate(" + count + ");' id='total_qntt_" + count + "' class='common_qnt total_qntt_" + count + " form-control text-right'  placeholder='0.00' min='0' tabindex='" + tab3 + "'/></td>" +
                "<td><button tabindex='" + tab5 + "' style='text-align: center;' class='btn btn-danger' type='button' value='Delete' onclick='deleteRow(this)'><i class='fa fa-close'></i></button></td>",
        ...
        var options = {
            ...
            select: function( event, ui ) {
                ...
                ({
                    ...
                    data: {product_id:id,outlet_id:outlet_id,csrf_test_name:csrf_test_name},
                    cache: false,
                    success: function(data)
                    {
