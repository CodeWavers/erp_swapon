...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <small>Manage Your Courier</small>
            <ol class="breadcrumb">
                <li><a href=""><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#">Courier</a></li>
                <li class="active">Manage Courier/li>
            </ol>
        </div>
    </section>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                           <a href="<?php echo base_url('Ccourier/category_downloadpdf')?>" class="btn btn-warning">Pdf</a>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    if ($category_list) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">{courier_name}{courier_id}</td>
                                            <td>
                                    <center>
                                        <?php echo form_open() ?>
