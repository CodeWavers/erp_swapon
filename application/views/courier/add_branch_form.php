...
<ul class="nav nav-tabs">
 <li class="active"><a data-toggle="tab" href="#categoryList"><i class="ti-align-justify"> </i> Manage Branch</a></li>
  <li><a data-toggle="tab" href="#add_category"><i class="fa fa-plus"> </i>Add Branch Name</a></li>
  <li><a data-toggle="tab" href="#csvupload"><i class="fa fa-file"> </i> Branch CSV Upload</a></li>
</ul>
...
<div class="tab-content">
  ...
  <div id="categoryList" class="tab-pane fade in active">
                            ...
                            <table id="dataTableExample3" class="table table-bordered table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <center>
                                        ...
                                        <a href="<?php echo base_url() . 'Ccourier/branch_update_form/{branch_id}'; ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                    <?php }?>
                                      <?php if($this->permission1->method('manage_category','delete')->access()){ ?>
                                        <a href="<?php echo base_url() . 'Ccourier/branch_delete/{branch_id}'; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are You Sure To Want To Delete ?')" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                    <?php }?>
                                            <?php echo form_close() ?>
                                    </center>
                                    </td>
    ...
    <div id="add_category" class="tab-pane fade">
         <div class="row cat-tabcontent">
      <?php echo form_open('Ccourier/insert_branch', array('class' => 'form-vertical', 'id' => 'insert_category')) ?>

                        <div class="form-group row">

                            <label for="category_name" class="col-sm-3 col-form-label">Courier Name <i class="text-danger">*</i></label>
                            <div class="col-sm-6">
                                <select class="form-control" name="courier_id" tabindex="3">
                                    {courier_list}
                                    <option value="{courier_id}">{courier_name}</option>
                                    {/courier_list}
