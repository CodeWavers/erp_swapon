...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Courier Ledger</h1>
            <small>Courier Ledger</small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#">Courier</a></li>
                <li class="active">Courier Ledger</li>
            </ol>
        </div>
    </section>
    ...
    <section class="content">
      ...
      <?php if($this->permission1->method('add_customer','create')->access()){ ?>
                    <a href="<?php echo base_url('Ccourier') ?>" class="btn btn-info m-b-5 m-r-2"><i class="fa fa-plus"> </i> Add Courier </a>
                   <?php }?>
                <?php if($this->permission1->method('manage_customer','read')->access()){ ?>
                    <a href="<?php echo base_url('Ccourier/branch') ?>" class="btn btn-primary m-b-5 m-r-2"><i class="fa fa-plus"> </i>  Add Branch</a>
                 <?php }?>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        <?php echo form_open('Ccourier/courier_ledgerData', array('class' => '', 'id' => 'validate')) ?>
