                                                        ...
                                                        <div class="col-xs-6 col-sm-4 col-md-2 col-p-3">
                                                            <div class="panel panel-bd product-panel select_product">
                                                                ...
                                                                <div class="panel-footer" onclick="onselectimage('<?php echo $item->product_id ?>')"><?php
                                                                                                                                                        $text = html_escape($item->product_name . ' (' . $item->product_model . ') (' . $item->color_name . ') (' . $item->size_name . ')');
                                                ...
                                                <div class="footer">
                                                    <div class="form-group row guifooterpanel">
                                                        <div class="col-sm-12"> <label for="date" class="col-sm-5 col-form-label"><?php echo display('invoice_discount') ?>:</label>
                                                            <div class="col-sm-5"> <input type="text" onkeyup="quantity_calculate(1);" onchange="quantity_calculate(1);" id="invoice_discount" class="form-control total_discount gui-foot text-right" name="invoice_discount" placeholder="0.00" />
                                                    ...
                                                    <div class="form-group row guifooterpanel">
                                                        <div class="col-sm-12"> <label for="date" class="col-sm-5 col-form-label"><?php echo display('total_discount') ?>:</label>
                                                            <div class="col-sm-5"> <input type="text" id="total_discount_ammount" class="form-control gui-foot text-right" name="total_discount" value="0.00" readonly="readonly" /></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row hiddenRow guifooterpanel" id="taxdetails">
                                                        ...
                                                        foreach ($taxes as $taxfldt) { ?>
                                                            ...
                                                            <div class="col-sm-12"> <label for="date" class="col-sm-5 col-form-label"><?php echo html_escape($taxfldt['tax_name']) ?>:</label>
                                                                <div class="col-sm-5"> <input id="total_tax_ammount<?php echo $x; ?>" tabindex="-1" class="form-control gui-foot text-right valid totalTax" name="total_tax<?php echo $x; ?>" value="0.00" readonly="readonly" aria-invalid="false" type="text">
                                                    ...
                                                    <div class="form-group row guifooterpanel">
                                                        ...
                                                        <div class="col-sm-12"> <label for="date" class="col-sm-5 col-form-label"><?php echo display('total_tax') ?>:</label>
                                                            <div class="col-sm-5"> <input id="total_tax_amount" tabindex="-1" class="form-control gui-foot text-right valid" name="total_tax" value="0.00" readonly="readonly" aria-invalid="false" type="text">
                                                    ...
                                                    <div class="form-group row guifooterpanel">
                                                        <div class="col-sm-12"> <label for="date" class="col-sm-5 col-form-label"><?php echo display('shipping_cost') ?>:</label>
                                                            <div class="col-sm-5"> <input type="text" id="shipping_cost" class="form-control gui-foot text-right" name="shipping_cost" onkeyup="quantity_calculate(1);" onchange="quantity_calculate(1);" placeholder="0.00" /></div>
                                                        </div>

                                                    </div>
                                                    <div class="form-group row guifooterpanel">
                                                        <div class="col-sm-12"> <label for="date" class="col-sm-5 col-form-label"><?php echo display('grand_total') ?>:</label>
                                                            <div class="col-sm-5"> <input type="text" id="grandTotal" class="form-control gui-foot text-right" name="grand_total_price" value="0.00" readonly="readonly" /></div>
                                                        </div>
                                                    </div>

                                                    <div class="form-group row guifooterpanel">
                                                        <div class="col-sm-12"> <label for="date" class="col-sm-5 col-form-label"><?php echo display('previous'); ?>:</label>
                                                            <div class="col-sm-5"> <input type="text" id="previous" class="form-control gui-foot text-right" name="previous" value="0.00" readonly="readonly" /></div>
                                                        </div>

                                                    </div>
                                                    <div class="form-group row guifooterpanel">
                                                        <div class="col-sm-12"> <label for="change" class="col-sm-5 col-form-label"><?php echo display('change'); ?>:</label>
                                                            <div class="col-sm-5"> <input type="text" id="change" class="form-control gui-foot text-right" name="change" value="0.00" readonly="readonly" /></div>
                                                        </div>
                                            ...
                                            <div class="bottomarea">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6 text-center">
                                                        <div class="col-sm-12">
                                                            <label for="net_total" class="col-sm-1 col-form-label"><?php echo display('net_total'); ?>:</label>
                                                            <div class="col-sm-3"> <input type="text" id="n_total" class="form-control text-right guifooterfixedinput" name="n_total" value="0" readonly="readonly" placeholder="" />
                                                                <input type="hidden" name="baseUrl" class="baseUrl" value="<?php echo base_url(); ?>" id="baseurl" />
                                                            </div>
                                                            <label for="date" class="col-sm-1 col-form-label"><?php echo display('paid_ammount') ?>:</label>
                                                            <div class="col-sm-3"> <input type="text" id="paidAmount" onkeyup="invoice_paidamount()" onkeypress="invoice_paidamount()" class="form-control text-right guifooterfixedinput" name="paid_amount" placeholder="0.00" tabindex="13" autocomplete="off" /></div>


                                                            <label for="date" class="col-sm-1 col-form-label"><?php echo display('due') ?>:</label>
                                                            <div class="col-sm-3"> <input type="text" id="dueAmmount" class="form-control text-right guifooterfixedinput" name="due_amount" value="0.00" readonly="readonly" /></div>
