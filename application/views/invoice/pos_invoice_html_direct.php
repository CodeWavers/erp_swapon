                                        ...
                                        <td>
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    ...
                                                    <td align="center" class="pprint-unit"><?php if ($is_unit != 0) {
                                                                                                echo display('unit');
                                                                                            } ?></td>
                                                    <td align="center"><?php echo display('quantity'); ?></td>
                                                    <td align="center"><?php if ($is_discount > 0) {
                                                                            echo display('discount');
                                                                        } else {
                                                                            echo '';
                                                                        } ?></td>
                                                ...
                                                foreach ($invoice_all_data as $invoice_data) { ?>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <nobr><?php echo html_escape($invoice_data['product_name']) . '(' . html_escape($invoice_data['product_model']) . ')'; ?></nobr>
                                                        </td>
                                                        <td align="center">
                                                ...
                                                <?php if ($total_tax > 0) { ?>
                                                    <tr>
                                                        ...
                                                        <td align="right" colspan="5">
                                                            <nobr><?php echo display('tax') ?></nobr>
                                                        </td>
                                                        <td align="right">
                                                            <nobr>
