...
class Lwarrenty {
    ...
    public function return_form() {
        ...
        $returnForm = $CI->parser->parse('warrenty/form', $data, true);
        return $returnForm;
    }
    ...
    public function invoice_return_data($invoice_id) {
        ...
        $data = array(
            ...
            'was_qty'     => $invoice_detail[0]['was_qty'],
            'invoice_all_data' => $invoice_detail,
            'discount_type' => $currency_details[0]['discount_type'],
        );
        $chapterList = $CI->parser->parse('warrenty/return_data_form', $data, true);
        return $chapterList;
    }
...
//start  Supplier return form data
    public function supplier_return_data($purchase_id) {
        ...
        $CI->load->model('Web_settings');
        $purchase_detail = $CI->Warrenty->supplier_return($purchase_id);
        ...
        $chapterList = $CI->parser->parse('warrenty/supplier_return_form', $data, true);
        return $chapterList;
    }
    ...
    public function return_list($links, $perpage, $page) {
        ...
        $return_list = $CI->Warrenty->return_list($perpage, $page);
        ...
        $returnList = $CI->parser->parse('warrenty/return_list', $data, true);
        return $returnList;
    }
...
// supplier return list
    public function supplier_return_list($links, $perpage, $page) {
        ...
        $return_list = $CI->Warrenty->supplier_return_list($perpage, $page);
        if (!empty($return_list)) {
            foreach ($return_list as $k => $v) {
                $return_list[$k]['final_date'] = $CI->occational->dateConvert($return_list[$k]['date_return']);
            }
        ...
        $returnList = $CI->parser->parse('warrenty/return_supllier_list', $data, true);
        return $returnList;
    }
    ...
    public function wastage_return_list($links, $perpage, $page) {
        ...
        $return_list = $CI->Warrenty->wastage_return_list($perpage, $page);
        if (!empty($return_list)) {
            foreach ($return_list as $k => $v) {
                $return_list[$k]['final_date'] = $CI->occational->dateConvert($return_list[$k]['date_return']);
            }
    ...
    public function exchange_stock_list($links, $perpage, $page) {
        ...
        $return_list = $CI->Warrenty->exchange_stock_list($perpage, $page);
        if (!empty($return_list)) {
            foreach ($return_list as $k => $v) {
                $return_list[$k]['final_date'] = $CI->occational->dateConvert($return_list[$k]['date_return']);
            }
        ...
        $returnList = $CI->parser->parse('warrenty/exchange_stock_list', $data, true);
        return $returnList;
    }
    public function repair_report_list($links, $perpage, $page) {
        ...
        $return_list = $CI->Warrenty->repair_report_list($perpage, $page);
        if (!empty($return_list)) {
            foreach ($return_list as $k => $v) {
                $return_list[$k]['final_date'] = $CI->occational->dateConvert($return_list[$k]['date_return']);
            }
        ...
        $returnList = $CI->parser->parse('warrenty/repair_report_list', $data, true);
        return $returnList;
    }
    ...
    public function invoice_html_data($invoice_id) {
        ...
        $CI->load->model('Web_settings');
        $CI->load->library('occational');
        $invoice_detail = $CI->Warrenty->retrieve_invoice_html_data($invoice_id);
        ...
        if (!empty($invoice_detail)) {
            foreach ($invoice_detail as $k => $v) {
                ...
                $subTotal_ammount = $subTotal_ammount + $invoice_detail[$k]['service_charge'];
            }
        ...
        $data = array(
            ...
            'service_charge'     => number_format($invoice_detail[0]['service_charge'], 2, '.', ','),
            ...
            'usablity'         => $invoice_detail[0]['usablity'],
            'invoice_all_data' => $invoice_detail,
        ...
        $chapterList = $CI->parser->parse('warrenty/return_invoice_html', $data, true);
        return $chapterList;
    }
    ...
    public function supplier_html_data($purchase_id) {
        ...
        $CI->load->model('Web_settings');
        $CI->load->library('occational');
        $return_detail = $CI->Warrenty->supplier_return_html_data($purchase_id);
        $subTotal_quantity = 0;
        $subTotal_cartoon = 0;
        $subTotal_discount = 0;
        $subTotal_ammount = 0;
        ...
        $chapterList = $CI->parser->parse('warrenty/return_supplier_html', $data, true);
        return $chapterList;
    }
    ...
    public function return_list_datebetween($from_date, $to_date, $links, $perpage, $page) {
        ...
        $return_list = $CI->Warrenty->return_dateWise_invoice($from_date, $to_date, $perpage, $page);
        if (!empty($return_list)) {
            foreach ($return_list as $k => $v) {
                $return_list[$k]['final_date'] = $CI->occational->dateConvert($return_list[$k]['date_return']);
            }
    ...
    public function datewise_supplier_return_list($from_date, $to_date, $links, $perpage, $page) {
        ...
        $return_list = $CI->Warrenty->return_dateWise_supplier($from_date, $to_date, $perpage, $page);
        if (!empty($return_list)) {
            foreach ($return_list as $k => $v) {
                $return_list[$k]['final_date'] = $CI->occational->dateConvert($return_list[$k]['date_return']);
            }
